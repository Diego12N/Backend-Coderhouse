...
console.log("Data Normalized", JSON.stringify(normalizedHolding).length);
...
console.log("Data Denormalized", JSON.stringify(denormalizedHolding).length);

const ahorro =
	((JSON.stringify(holding).length - JSON.stringify(normalizedHolding).length) /
